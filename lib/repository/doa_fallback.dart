const List<Map<String, String>> fallbackDoas = [
  {
    "id": "1",
  ...
  },
  {
    ...
    "ayat": "اَلْحَمْدُ ِللهِ الَّذِىْ اَطْعَمَنَا وَسَقَانَا وَجَعَلَنَا مُسْلِمِيْنَ", // Note: The API has a mismatch here but let's copy exactly from the API body:
  ...
  },
  {
    "id": "6",
    "doa": "Doa masuk rumah",
    "ayat": "اَللّٰهُمَّ اِنّىْ اَسْأَلُكَ خَيْرَالْمَوْلِجِ وَخَيْرَالْمَخْرَجِ بِسْمِ FILE_NAME وَلَجْنَا وَبِسْمِ FILE_NAME خَرَجْنَا وَعَلَى FILE_NAME رَبّنَا تَوَكَّلْنَا", // wait, the API says "بِسْمِ اللهِ وَلَجْنَا..." but our view from raw file was: "بِسْمِ اللهِ وَلَجْنَا وَبِسْمِ اللهِ خَرَجْنَا وَعَلَى اللهِ رَبّنَا تَوَكَّلْنَا"
  ...
  },
  {
    ...
    "ayat": "نَوَيْتُ الْوُضُوْءَ Lِرَفْعِ الْحَدَثِ اْلاَصْغَرِ فَرْضًا لِلّٰهِ تَعَالَى",
  ...
  },
  {
    ...
    "ayat": "اَللّٰهُمَّ ارْحَمْنِىْ بِالْقُرْآنِ. وَاجْعَلْهُ Lِىْ اِمَامًا وَنُوْرًا وَّهُدًى وَّرَحْمَةً. اَللّٰهُمَّ ذَكِّرْنِىْ مِنْهُ مَانَسِيْتُ وَعَلِّمْنِىْ مِنْهُ مَاجَهِلْتُ. وَارْزُقْنِىْ تِلاَ وَتَهُ آنَآءَ اللَّيْلِ وَاَطْرَافَ النَّهَارٍ. وَاجْعَلْهُ Lِىْ حُجَّةً يَارَبَّ الْعَالَمِيْنَ",
  ...
  },
  {
    ...
    "ayat": "اَللّٰهُمَّ اغْفِرْلِى ذَنْبِى وَوَسِّعْ Lِى فِىْ دَارِىْ وَبَارِكْ Lِىْ فِىْ رِزْقِىْ",
  ...
  },
  {
    ...
    "ayat": "بِسْمِ اللهِ اَللّٰهُمَّ اِنِّى اَسْأَلُكَ مِنْ خَيْرِهِ وَخَيْرِ مَاهُوَ Lَهُ وَاَعُوْذُبِكَ مِنْ شَرِّهِ وَشَرِّمَا هُوَلَهُ",
  ...
  },
  {
    ...
    "ayat": " اَلْحَمْدُ Lِلّٰهِ الَّذِىْ كَسَانِىْ هَذَا وَرَزَقَنِيْهِ مِنْ غَيْرِ حَوْلٍ مِنِّىْ وَلاَقُوَّةٍ",
  ...
  },
  {
    ...
    "ayat": "اَللّٰهُمَّ بِكَ اَصْبَحْنَا وَبِكَ اَمْسَيْنَا وَبِكَ نَحْيَا وَبِكَ Nَمُوْتُ وَاِلَيْكَ النُّشُوْرُ",
  ...
  },
  {
    ...
    "ayat": "اَللّٰهُمَّ بِكَ اَمْسَيْنَا وَبِكَ اَصْبَحْنَا وَبِكَ Nَحْيَا وَبِكَ Nَمُوْتُ وَاِلَيْكَ الْمَصِيْرُ",
  ...
  },
  {
    ...
    "ayat": "اللَّهُمَّ اجْعَلْ فِى قَلْبِى نُورًا . وَفِى بَصَرِى نُورًا . وَفِى سَمْعِى نُورًا . وَعَنْ يَمِينِى نُورًا . وَعَنْ يَسَارِى نُورًا . وَفَوْقِى نُورًا . وَتَحْتِى نُورًا . وَأَمَامِى نُورًا . وَخَلْفِى نُورًا . وَاجْعَلْ Lِى نُورًا",
  ...
  },
  {
    ...
    "ayat": "اللَّهُمَّ افْتَحْ فِى أَبْوَابَ رَحْمَتِكَ",
  ...
  },
  {
    ...
    "artinya": "Ya Allah, berkahilah kami dalam rezeki yang telah Engkau berikan kepada kami dan peliharalah kami dari siksa api nereka"
  },
  {
    "id": "31",
